    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BaseballAPI.Data.ApplicationDbContext>
    {
        ...
        protected override void Seed(BaseballAPI.Data.ApplicationDbContext context)
        {
            ...
            context.Games.AddOrUpdate(x => x.GameId,
                ...
                new GameInfo() { GameId = 2, HomeTeamID = 3, AwayTeamID = 4, HomeScore = 3, AwayScore = 0, Innings = 9, SeasonYear = 2022 },
                new GameInfo() { GameId = 3, HomeTeamID = 6, AwayTeamID = 5, HomeScore = 2, AwayScore = 1, Innings = 10, SeasonYear = 2022 });
            ...
            context.GameBattingStats.AddOrUpdate(x => x.Id,
               new GameBattingStat() { Id = 2, PlayerId = 2, GameId = 1, AB = 4, R = 0, H = 2, RBI = 1, BB = 0, SO = 0, HR = 0, Double = 1, Triple = 0, SAC = 0, HBP = 0, SB = 1, CS = 0 }
                );
            context.GameBattingStats.AddOrUpdate(x => x.Id,
               new GameBattingStat() { Id = 3, PlayerId = 3, GameId = 1, AB = 3, R = 1, H = 1, RBI = 2, BB = 1, SO = 0, HR = 1, Double = 0, Triple = 0, SAC = 0, HBP = 0, SB = 0, CS = 0 }
                );
            context.GameBattingStats.AddOrUpdate(x => x.Id,
               new GameBattingStat() { Id = 4, PlayerId = 4, GameId = 1, AB = 3, R = 1, H = 3, RBI = 2, BB = 1, SO = 0, HR = 1, Double = 0, Triple = 0, SAC = 0, HBP = 0, SB = 0, CS = 0 }
                );
